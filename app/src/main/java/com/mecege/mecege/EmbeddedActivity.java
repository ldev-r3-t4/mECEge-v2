...
public class EmbeddedActivity extends AppCompatActivity {

    Button button;
    private int embedded_message_count = 0;
    ...
    public void addRefreshButton() {
        button = (Button) findViewById(R.id.embedded_refreshbutton);
        button.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                embedded_message_count = 10;
                getMessages();
    ...
    public void addLoadButton() {
        button = (Button) findViewById(R.id.embedded_loadbutton);
        button.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                embedded_message_count += 10;
    ...
    public void addSendButton() {
        button = (Button) findViewById(R.id.embedded_sendbutton);
        button.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                embedded_message_count = 10;
    ...
    public void updateMessageView(String toThis) {
        TextView textView = (TextView) findViewById(R.id.embedded_messageview);
    ...
    private void sendMessage() {
        ...
        EditText editText = (EditText) findViewById(R.id.embedded_messagebox);
