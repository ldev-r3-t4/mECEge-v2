...
public class DD1Activity extends AppCompatActivity {
    ...
    Button button;
    private int dd1_message_count = 0;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_dd1);
    ...
    public void addRefreshButton() {
        button = (Button) findViewById(R.id.dd1_refreshbutton);
        button.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                dd1_message_count = 10;
                getMessages();
    ...
    public void addLoadButton() {
        button = (Button) findViewById(R.id.dd1_loadbutton);
        button.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                dd1_message_count += 10;
    ...
    public void addSendButton() {
        button = (Button) findViewById(R.id.dd1_sendbutton);
        button.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                dd1_message_count = 10;
    ...
    public void updateMessageView(String toThis) {
        TextView textView = (TextView) findViewById(R.id.dd1_messageview);
    ...
    private void sendMessage() {
        ...
        EditText editText = (EditText) findViewById(R.id.dd1_messagebox);
