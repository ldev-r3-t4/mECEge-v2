...
public class CircuitActivity extends AppCompatActivity {
    ...
    Button button;
    private int circuit_message_count = 0;
    ...
    public void addRefreshButton() {
        button = (Button) findViewById(R.id.circuit_refreshbutton);
        button.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                circuit_message_count = 10;
                getMessages();
    ...
    public void addLoadButton() {
        button = (Button) findViewById(R.id.circuit_loadbutton);
        button.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                circuit_message_count += 10;
    ...
    public void addSendButton() {
        button = (Button) findViewById(R.id.circuit_sendbutton);
        button.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                circuit_message_count = 10;
    ...
    public void updateMessageView(String toThis) {
        TextView textView = (TextView) findViewById(R.id.circuit_messageview);
    ...
    private void sendMessage() {
        ...
        EditText editText = (EditText) findViewById(R.id.circuit_messagebox);
