...
public class IntroActivity extends AppCompatActivity {
    ...
    Button button;
    private int intro_message_count = 0;
    ...
    public void addRefreshButton() {
        button = (Button) findViewById(R.id.intro_refreshbutton);
        button.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                intro_message_count = 10;
                getMessages();
    ...
    public void addLoadButton() {
        button = (Button) findViewById(R.id.intro_loadbutton);
        button.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                intro_message_count += 10;
    ...
    public void addSendButton() {
        button = (Button) findViewById(R.id.intro_sendbutton);
        button.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                intro_message_count = 10;
    ...
    public void updateMessageView(String toThis) {
        TextView textView = (TextView) findViewById(R.id.intro_messageview);
    ...
    private void sendMessage() {
        ...
        EditText editText = (EditText) findViewById(R.id.intro_messagebox);
